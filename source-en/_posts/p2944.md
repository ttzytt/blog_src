...
- Solutions
keywords:
description: Transforms Earthquake Damage 2 into a vertex-cut problem and uses node splitting with max flow to find the minimum number of removed vertices.
