...
alias:
  - "2022/08/xv6_lab9_record/index.html"
...
- Lab Records
keywords:
description: Notes on xv6 Lab 9 locks, reducing contention in the memory allocator and buffer cache through per-CPU free lists and hashed buffer buckets.
