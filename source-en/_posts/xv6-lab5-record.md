...
alias:
  - "2022/07/xv6_lab5_record/index.html"
...
- Lab Records
keywords:
description: Notes on xv6 Lab 5 lazy page allocation, removing eager sbrk allocation, handling page faults, and passing lazy-allocation and user tests.
